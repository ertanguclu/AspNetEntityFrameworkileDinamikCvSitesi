...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Ertan Güçlü</a></h1>
        ...
        <section class="wedo" id="contact">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" placeholder="Adınız" Height="50px" TextMode="MultiLine"></asp:TextBox>
